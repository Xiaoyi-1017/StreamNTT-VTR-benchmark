...
# input files: [bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP_tw_factors_ROM_AUTO_1R.v bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP.v bf_unit_mem0_RAM_S2P_LUTRAM_1R1W.v bf_unit_mul_32ns_32ns_64_2_1.v bf_unit.v l_stages_fsm.v l_stages.v top.v]
...
if {$env(PARSER) == "slang" } {
	...
	build_filelist {bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP_tw_factors_ROM_AUTO_1R.v bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP.v bf_unit_mem0_RAM_S2P_LUTRAM_1R1W.v bf_unit_mul_32ns_32ns_64_2_1.v bf_unit.v l_stages_fsm.v l_stages.v top.v} $readfile
	...
	read_verilog -sv -nolatches bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP_tw_factors_ROM_AUTO_1R.v bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP.v bf_unit_mem0_RAM_S2P_LUTRAM_1R1W.v bf_unit_mul_32ns_32ns_64_2_1.v bf_unit.v l_stages_fsm.v l_stages.v top.v
