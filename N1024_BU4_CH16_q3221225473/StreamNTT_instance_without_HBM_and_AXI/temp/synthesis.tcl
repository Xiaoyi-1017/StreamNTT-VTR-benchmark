...
# input files: [bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP_tw_factors_ROM_AUTO_1R.v bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP.v bf_unit_mem0_RAM_S2P_LUTRAM_1R1W.v bf_unit_mul_32ns_32ns_64_2_1.v bf_unit.v fifo_bram.v fifo_fwd.v fifo_srl.v fifo.v generate_last.v input_mem_stage_input_mem_stage_Pipeline_INPUT_MEM_STAGE_LOOP.v input_mem_stage_mem0_RAM_S2P_LUTRAM_1R1W.v input_mem_stage.v l_stages_fsm.v l_stages.v ntt_core_fsm.v ntt_core.v x_stages_mul_32ns_32ns_64_2_1.v x_stages_sparsemux_9_2_32_1_1.v x_stages.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_0_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_1_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_2_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_3_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP.v top.v]
...
if {$env(PARSER) == "slang" } {
	...
	read_verilog -sv -nolatches bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP_tw_factors_ROM_AUTO_1R.v bf_unit_bf_unit_Pipeline_BF_UNIT_LOOP.v bf_unit_mem0_RAM_S2P_LUTRAM_1R1W.v bf_unit_mul_32ns_32ns_64_2_1.v bf_unit.v fifo_bram.v fifo_fwd.v fifo_srl.v fifo.v generate_last.v input_mem_stage_input_mem_stage_Pipeline_INPUT_MEM_STAGE_LOOP.v input_mem_stage_mem0_RAM_S2P_LUTRAM_1R1W.v input_mem_stage.v l_stages_fsm.v l_stages.v ntt_core_fsm.v ntt_core.v x_stages_mul_32ns_32ns_64_2_1.v x_stages_sparsemux_9_2_32_1_1.v x_stages.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_0_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_1_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_2_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP_p_ZL10tw_factors_3_ROM_AUTO_1R.v x_stages_x_stages_Pipeline_NTT_SPATIAL_LOOP.v top.v
