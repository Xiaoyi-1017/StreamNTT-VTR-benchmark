...
run-vtr-flow:
	...
	$(VTR_DIR)/.venv/bin/python3 $(VTR_DIR)/vtr_flow/scripts/run_vtr_flow.py ./verilog/top.v /mnt/vault2/rsunketa/dpc-ram/vtr_proj/direct_bram_dsp_arch.xml -include $(filter-out ./verilog/top.v, $(wildcard ./verilog/*.v))
